...
Again, let the first term be 3⅓, the last 7⅔, and the difference 1⁴⁄₉,
the number of terms will be $$\frac{7\frac{2}{3}-3\frac{1}{3}}{1\frac{4}{9}}+1=4$$;
which are,
...
value of $$\frac{z-a}{d}$$, it will be impossible to resolve the question;
...
1. Leonhard Euler. *Elements of Algebra*. Translated by Rev. John Hewlett. Third Edition. Longmans, Hurst, Rees, Orme, and Co. London. 1822.
    - [Part {{ page.part }}. Section {{ page.section }}. {{ page.title }}](/EulerAlgebra/en/III-3.pdf)
2. Leonhard Euler. *Vollständige Anleitung zur Algebra. Mit den Zusätzen von Joseph Louis Lagrange.* Herausgegeben von Heinrich Weber. B. G. Teubner. Leipzig and Berlin. 1911. Leonhardi Euleri Opera omnia. Series prima. Opera mathematica. Volumen primum.
    - [Erster Theil. Dritter Abschnitt. Capitel 3. Von den arithmetischen Progressionen](/EulerAlgebra/de/I-III-3.pdf)